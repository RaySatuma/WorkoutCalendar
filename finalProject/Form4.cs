...
namespace finalProject
{
    public partial class Form4 : Form
    {
        ...
        public double Exercise_Calorie_total;
        ...
        private void Form4_Load(object sender, EventArgs e)
        {
            ...
            F4_Language.Visible = false;
            if (F4_Language.Text == "Language")
            {
                ...
                F4_Confirm_Button.Text = "Confirm";
            }
            else if (F4_Language.Text == "語言")
            {
                ...
                F4_Confirm_Button.Text = "確認";
            }
            else if (F4_Language.Text == "言語")
            {
        ...
        private void F4_Confirm_Button_Click(object sender, EventArgs e)
        {
            ...
            Exercise_Calorie_total += Exercise_Calorie;
        }

        private void Exercise_Time_box_TextChanged(object sender, EventArgs e)
        {
            if (int.TryParse(Exercise_Time_Text.Text, out Exe_temp) == false)
            {
                if (F4_Language.Text == "Language")
                {
